...
const sections = [
  ...
  ['air-fryer', 'Snacks air fryer', 'Snacks y combos preparados en air fryer.', [
    ...
    p('Boneless (250 g)|Boneless crujientes en air fryer · valores aproximados|590|33|2|179|125.3'),
    p('Alitas de Pollo (6 piezas)|Alitas crujientes en air fryer · valores aproximados|470|37|0|99|69.3'),
    p('Alitas de Pollo (12 piezas)|Alitas crujientes en air fryer · valores aproximados|940|74|0|179|125.3'),
